...
config.spotify= {};
  config.spotify.client_id = process.env.SPOTIFY_ID || '';
  config.spotify.client_secret = process.env.SPOTIFY_SECRET || '';
...
config.youtube = {};
  config.youtube.client_id = process.env.YOUTUBE_ID || '';
  config.youtube.client_secret = process.env.YOUTUBE_SECRET || '';
